<?php
    ...
    $delete_partner=new connect;
    if(isset($_GET['delete_partner'])){
        $id=$_GET['delete_partner'];
        $delete_partner->delete_partner($id);
...
<tr>
        ...
        <td><a href="update_partner.php?update_partner=<?php echo $fuser['id']?>">Edit </a><a href="show_partner.php?delete_partner=<?php echo $fuser['id']?>">ลบ</a></td>
</tr>
<?php } ?>
</table>
</td>
