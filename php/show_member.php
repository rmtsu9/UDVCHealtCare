<?php
    ...
    $logout=new connect;
    $show_member=new connect;
    $data_member=$show_member->show_member();
    $delete_member=new connect;
    if(isset($_GET['delete_member'])){
        $id=$_GET['delete_member'];
        $delete_member->delete_member($id);
...
<?php while($fuser=mysqli_fetch_array($data_member)) { ?>
<tr>
        <td><?php echo $fuser['id']?></td>
        <td><?php echo $fuser['name']?></td>
        <td><?php echo $fuser['lastname']?></td>
        <td><?php echo $fuser['user']?></td>
        <td><?php echo $fuser['password']?></td>
        <td><a href="update_member.php?update_member=<?php echo $fuser['id']?>">Edit </a><a href="show_member.php?delete_member=<?php echo $fuser['id']?>">ลบ</a></td>
</tr>
<?php } ?>
</table>
</td>
